...
var $lang = array(
	'documentation' => array (
		...
		'introduction_content' => 'The "HTFS-IM" plugin provisions server in memeory (tmpfs).',
		'requirements_title' => 'Requirements',
		'requirements_list' => 'A resource for the HTFS-IM Storage (this can be a remote system integrated into htvcenter e.g. via the "local-server" plugin or the htvcenter server itself)',

		'tested_title' => 'Tested with',
		'tested_content' => 'This plugin is tested with the Debian, Ubuntu and CentOS Linux distributions.',

		'provides_title' => 'Provides',
		'provides_list' => '<ul><li>Storage type: "HTFS-IM"</li><li>Deployment types: "Tmpfs-root deployment"</li></ul>',
	...
	function documentation( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new tmpfs_storage_about_documentation($this->htvcenter, $this->response);
