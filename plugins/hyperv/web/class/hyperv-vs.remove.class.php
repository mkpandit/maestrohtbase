...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/hyperv-vs-remove.tpl.php');
		...
		if( $vswitch_arr !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				foreach($vswitch_arr as $key => $vs) {
					...
					$command  = $this->htvcenter->get('basedir')."/plugins/hyperv/bin/htvcenter-hyperv-network remove_vs -i ".$this->resource->ip." -n ".$vs;
