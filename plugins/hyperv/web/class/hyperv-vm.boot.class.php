...
var $lang = array();
	...
	function vm_boot() {
		...
		$command  = $this->htvcenter->get('basedir')."/plugins/hyperv/bin/htvcenter-hyperv-vm setboot -i ".$this->resource->ip." -n ".$vm_name." -b ".$new_vm_boot_order;
