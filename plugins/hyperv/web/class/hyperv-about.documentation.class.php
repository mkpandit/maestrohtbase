...
class hyperv_about_documentation
{
/**
...
* @var string
*/
var $actions_name = 'hyperv_about_action';
/**
* message param
* @access public
* @var string
*/
var $message_param = "hyperv_about_msg";
/**
* path to templates
* @access public
* @var string
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/hyperv-about-documentation.tpl.php');
