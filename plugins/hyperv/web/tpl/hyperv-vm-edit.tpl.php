...
<div id="form">
	<div style="width:400px;float:left;">
		<div><b>{lang_id}</b>: <span id="aplidoo">{id}</span></div>
	...
	<div style="width:230px;float:right;">
		<div>{add_local_vm}</div>
		<!--<div>{add_network_vm}</div>-->
	</div>
...
<div id="volumepopuprem" class="modal-dialog popupremdialog remremrem">
<div class="panel">
                                    ...
                                    <ul class="wz-nav-off wz-icon-inline wz-classic">
                                        <li class="col-xs-3 bg-info active">
                                            <a href="#demo-cls-tab1" data-toggle="tab" aria-expanded="true">
                                                <span class="icon-wrap icon-wrap-xs bg-trans-dark"><i class="fa fa-cog"></i></span> List action
                                            </a>
                                        </li>
