...
class ansible_about_documentation
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$svn_co_command = "svn co svn+ssh://[user]@[htvcenter-server-ip]".$this->basedir."/htvcenter/plugins/ansible/etc/ansible/";
		$t = $this->response->html->template($this->tpldir.'/ansible-about-documentation.tpl.php');
