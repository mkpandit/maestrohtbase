...
var $lang = array(
	...
	function select( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_select($this->htvcenter, $this->response);
	...
	function rest( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_rest($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function api( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_api($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function template( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_template($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function lang( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_lang($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function docblock( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_docblock($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function hooks( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_hooks($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function js( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_js($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function css( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new development_css($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
