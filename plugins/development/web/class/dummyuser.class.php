...
var $_role_table = '';
	...
	function query_insert(){
		...
		return htvcenter_db_get_result($query);
	}
	//-----------------------------------------------------------------------------------
	...
	function check_user_exists() {
		$query = "
			...
			WHERE user_name = '".$this->name."'
		";
		$result = htvcenter_db_get_result_single($query);
	...
	function get_role_name() {
		...
		";
		$result = htvcenter_db_get_result_double($query);
		$this->role = $result[0];
	}
	//-----------------------------------------------------------------------------------
	...
	*/
	...
	function get_users() {
		$query = '
			...
			ORDER BY user_name
		';
		$ar_db = htvcenter_db_get_result($query);
		$ar_headline = array();
