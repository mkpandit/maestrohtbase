...
function get_iscsi_deployment_image_rootdevice_identifier($iscsi_storage_id) {
	...
	// send command
	$resource_command=$htvcenter_SERVER_BASE_DIR."/htvcenter/plugins/iscsi-storage/bin/htvcenter-iscsi-storage post_identifier -u ".$htvcenter_ADMIN->name." -p ".$htvcenter_ADMIN->password." --htvcenter-cmd-mode background";
