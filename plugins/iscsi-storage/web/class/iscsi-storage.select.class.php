...
var $lang = array();
	...
	function action() {
		$table = $this->select();
		$t = $this->response->html->template($this->tpldir.'/iscsi-storage-select.tpl.php');
	...
	function select() {
		...
		$deployment->get_instance_by_type("iscsi-deployment");
		$table = $this->response->html->tablebuilder('iscsi', $this->response->get_array($this->actions_name, 'select'));
