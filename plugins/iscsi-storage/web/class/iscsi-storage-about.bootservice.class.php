<?php
/**
 * iscsi-storage-about Boot-Service
 *
...
class iscsi_storage_about_bootservice
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/iscsi-storage-about-bootservice.tpl.php');
