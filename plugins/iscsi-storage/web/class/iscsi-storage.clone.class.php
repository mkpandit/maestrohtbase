...
var $lang = array();
	...
	function duplicate() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			$command     = $this->htvcenter->get('basedir').'/plugins/iscsi-storage/bin/htvcenter-iscsi-storage clone';
			...
			if(isset($error)) {
				...
				$file = $this->htvcenter->get('basedir').'/plugins/iscsi-storage/web/storage/'.$resource->id.'.iscsi.'.$name.'.sync_progress';
