			...
			switch ($image_command) {
				case 'add':
					...
					if (strlen($image->id)) {
						...
						$ident_file = $this->htvcenter->get('basedir').'/plugins/iscsi-storage/web/storage/'.$this->resource->id.'.iscsi.'.$image_name.'.adapt';
						$get_ident_command  = $this->htvcenter->get('basedir').'/plugins/iscsi-storage/bin/htvcenter-iscsi-storage adapt';
