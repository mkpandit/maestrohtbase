...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/iscsi-storage-remove.tpl.php');
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				foreach($exports as $key => $export) {
					...
					if (count($appliances_using_resource) > 0) {
						...
						$command  = $this->htvcenter->get('basedir').'/plugins/iscsi-storage/bin/htvcenter-iscsi-storage remove -n '.$export;
