...
var $lang = array(
	...
	function select( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new template_select($this->htvcenter, $this->response);
	...
	function config( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new template_config($this->htvcenter, $this->response);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function edit( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new template_edit($this->htvcenter, $this->response);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
