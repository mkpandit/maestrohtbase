...
function create_clone_template_deployment($cloud_image_id, $image_clone_name, $disk_size) {
	...
	$image_clone_cmd=$htvcenter_SERVER_BASE_DIR."/htvcenter/plugins/template/bin/htvcenter-template snap -n ".$image_location_name." -v ".$volume_group." -s ".$image_clone_name." -m ".$disk_size." --htvcenter-cmd-mode background";
...
function remove_template_deployment($cloud_image_id) {
	...
	$image_remove_clone_cmd=$htvcenter_SERVER_BASE_DIR."/htvcenter/plugins/template/bin/htvcenter-template remove -n ".$image_location_name." -v ".$volume_group." --htvcenter-cmd-mode background";
...
function resize_template_deployment($cloud_image_id, $resize_value) {
	...
	$image_resize_cmd=$htvcenter_SERVER_BASE_DIR."/htvcenter/plugins/template/bin/htvcenter-template resize -n ".$image_location_name." -v ".$volume_group." -m ".$resize_value." --htvcenter-cmd-mode background";
...
function create_private_template_deployment($cloud_image_id, $private_disk, $private_image_name) {
	...
	$image_resize_cmd=$htvcenter_SERVER_BASE_DIR."/htvcenter/plugins/template/bin/htvcenter-template clone -n ".$image_location_name." -s ".$private_image_name." -v ".$volume_group." -m ".$private_disk." -u ".$htvcenter_admin_user->name." -p ".$htvcenter_admin_user->password." --htvcenter-cmd-mode background";
