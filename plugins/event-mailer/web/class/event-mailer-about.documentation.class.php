<?php
/**
 * event-mailer-about Documentation
 *
...
class event_mailer_about_documentation
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/event-mailer-about-documentation.tpl.php');
