...
// define Cloud user and password to authenticate the soap-client against the htvcenter Cloud
$cloud_user = $_SERVER['PHP_AUTH_USER'];
$cloud_password = $_SERVER['PHP_AUTH_PW'];

// url for the wdsl
$surl = "http://$htvcenter_SERVER_IP_ADDRESS/htvcenter/boot-service/clouduser.wdsl";
...
echo "<br>";
echo "<h2>Examples for the htvcenter User SOAP-Service</h2>";
