                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active in" id="demo-cls-tab1">
                                                    <div id="storageform" class="updatoo">
...
<div id="volumepopupz" class="modal-dialog">
<div class="panel">
                                ...
                                <div id="demo-cls-wz">
                                    ...
                                    <ul class="wz-nav-off wz-icon-inline wz-classic">
                                        <li class="col-xs-3 bg-info active">
                                            <a href="#demo-cls-tab1" data-toggle="tab" aria-expanded="true">
                                                <span class="icon-wrap icon-wrap-xs bg-trans-dark"><i class="fa fa-plus"></i></span> New
                                            </a>
                                        </li>
                                        <div class="volumepopupclass"><a id="volumepopupzclose"><i class="fa fa-icon fa-close"></i></a></div>
