...
<div id="volumepopup" class="modal-dialog clouddialog">
<div class="panel">
                                    ...
                                    <form class="form-horizontal mar-top">
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="left alalalaleft">
                                                  <label>Assign IP Network Private to Cloud Usergroup</label>
                                                </div>  
                                                <div class="right ololorighttt" id="storageform">
