...
// define htvcenter user and password to authenticate the soap-client against htvcenter
$htvcenter_user = "htvcenter";
$htvcenter_password = "htvcenter";

// url for the wdsl
$surl = "http://$htvcenter_SERVER_IP_ADDRESS/htvcenter/boot-service/cloudadmin.wdsl";

// turn off the WSDL cache
ini_set("soap.wsdl_cache_enabled", "0");

// create the soap-client
$client = new SoapClient($surl, array('soap_version' => SOAP_1_2, 'trace' => 1, 'login'=> $htvcenter_user, 'password' => $htvcenter_password ));
...
switch ($action) {
	...
	case 'deprovision':
		$deprovision_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_id'];
	...
	case 'cancel':
		$cancel_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_id'].",new";
		$cr_id = $request_fields['cr_id'];
		try {
	...
	case 'approve':
		$approve_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_id'].",approve";
		$cr_id = $request_fields['cr_id'];
		try {
	...
	case 'deny':
		$deny_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_id'].",deny";
		$cr_id = $request_fields['cr_id'];
		try {
	...
	case 'remove':
		$remove_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_id'];
		$cr_id = $request_fields['cr_id'];
		try {
	...
	case 'usercreate':
		$create_user_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_username'].",".$request_fields['cr_userpassword'].",".$request_fields['cr_useremail'].",,,,,,,,";
		try {
	...
	case 'userremove':
		$remove_user_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_username'];
		try {
	...
	case 'setCCUs':
		...
		$setccus_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$clouduser_name.",".$clouduser_ccus;
		try {
	...
	// ######################### cloud User setCCUs example ####################
	case 'setlimits':
		$setlimit_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_username'].",".$request_fields['cr_resource_limit'].",".$request_fields['cr_memory_limit'].",".$request_fields['cr_disk_limit'].",".$request_fields['cr_cpu_limit'].",".$request_fields['cr_network_limit'];
		try {
	...
	case 'appliance_pause':
		$appliance_pause_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_cloudappliance_id'].",stop";
		try {
	...
	case 'appliance_unpause':
		$appliance_unpause_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_cloudappliance_id'].",start";
		try {
	...
	case 'appliance_restart':
		$appliance_restart_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_cloudappliance_id'].",restart";
		try {
	...
	case 'appliance_comment':
		...
		$appliance_comment_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_cloudappliance_id'].",".$updated_appliance_comment;
		try {
	...
	case 'push':
		$transaction_parameters = "admin,".$htvcenter_user.",".$htvcenter_password.",".$request_fields['cr_username'].",".$request_fields['cr_id'].",".$request_fields['cr_ccu_charge'].",".$request_fields['cr_ccu_balance'].",".$request_fields['cr_reason'].",".$request_fields['cr_comment'];
		try {
...
echo "<br>";
echo "<h2>Examples for the htvcenter Admin SOAP-Service</h2>";
...
$usergetlist_parameter = "admin,$htvcenter_user,$htvcenter_password";
try {
...
$kernelgetlist_parameter = "admin,$htvcenter_user,$htvcenter_password";
try {
...
$imagegetlist_parameter = "admin,$htvcenter_user,$htvcenter_password,$htvcenter_user";
try {
...
$virtualizationgetlist_parameter = "admin,$htvcenter_user,$htvcenter_password";
try {
...
$puppetgetlist_parameter = "admin,$htvcenter_user,$htvcenter_password";
try {
...
$cloudrequestgetlist_parameter = "admin,$htvcenter_user,$htvcenter_password,";
try {
...
foreach($cloudrequest_list as $cr_id) {
	...
	echo "<form action=$thisfile method=post>";
	echo "<nobr><pre>";
	$cloudrequestgetdetails_parameter = "admin,$htvcenter_user,$htvcenter_password,$cr_id";
	try {
...
$cloudusergetccus_parameter = "admin,$htvcenter_user,$htvcenter_password,$cloud_user";
try {
...
try {
	$cloud_user_list = $client->CloudUserGetList($usergetlist_parameter);
	foreach($cloud_user_list as $cloud_user) {
		$cloudusergetdetails_parameter = "admin,$htvcenter_user,$htvcenter_password,$cloud_user";
...
try {
	$cloudusergetlist_parameter = "admin,$htvcenter_user,$htvcenter_password";
	$cloud_user_list = $client->CloudUserGetList($cloudusergetlist_parameter);
} catch (Exception $e) {
	echo 'Caught exception: ',  $e->getMessage(), "<br>";
}
foreach($cloud_user_list as $cloud_user) {
	$cloudusergetlimits_parameter = "admin,$htvcenter_user,$htvcenter_password,$cloud_user";
	try {
...
$cloudappliancegetlist_parameter = "admin,$htvcenter_user,$htvcenter_password,";
try {
...
foreach($cloudappliance_list as $ca_id) {
	...
	echo "<nobr><pre>";
	$cloudappliancegetdetails_parameter = "admin,$htvcenter_user,$htvcenter_password,$ca_id";
	try {
	...
	// ######################### Cloud sshterm example ##############################
		...
		echo "ssh-login example <input type=submit name='action' value='appliance_login'>";
	// ######################### Cloud sshterm example ##############################
		echo "<br>";
	// ######################### Cloud appliance command example ##############################
...
function sshterm_login($ip) {
	$htvcenter_PLUGIN_AJAXTERM_REVERSE_PROXY_PORT=44322;
	$redirect_url="https://$ip:$htvcenter_PLUGIN_AJAXTERM_REVERSE_PROXY_PORT";
	$left=50+($id*50);
	$top=100+($id*50);
?>
