...
var $lang = array();
	...
	function __construct($htvcenter, $response, $controller) {
		...
		$this->statfile = $this->htvcenter->get('basedir').'/plugins/network-manager/web/storage/'.$this->resource->id.'.network_config';
	}
	...
	function add() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			if(!$form->get_errors()) {
				$command  = $this->htvcenter->get('basedir').'/plugins/network-manager/bin/htvcenter-network-manager add_br';
				...
				if(isset($error)) {
					...
					$file = $this->htvcenter->get('basedir').'/plugins/network-manager/web/storage/'.$this->resource->id.'.network_stat';
