...
var $lang = array();
	...
	function __construct($htvcenter, $response) {
		...
		$this->statfile = $this->htvcenter->get('basedir').'/plugins/network-manager/web/storage/'.$this->resource->id.'.network_stat';
	}
		...
		if( $bridges !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				foreach($bridges as $key => $bridge) {
					$command  = $this->htvcenter->get('basedir').'/plugins/network-manager/bin/htvcenter-network-manager remove_br';
					$command .= ' -b '.$bridge;
