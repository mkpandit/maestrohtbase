...
<h2>{label}</h2>
<div id="form">
<div style="width:300px; float:right;" id="nwaddbtn">{add}</div>
{servid}
<div class="floatbreaker" style="clear:both; margin: 0 0 25px 0;">&#160;</div>
{table}
</div>

<div id="volumepopup" class="modal-dialog networkmanagerpopupform">
<div class="panel">
                                    ...
                                    <ul class="wz-nav-off wz-icon-inline wz-classic">
                                        <li class="col-xs-3 bg-info active">
                                            <a href="#demo-cls-tab1" data-toggle="tab" aria-expanded="true">
                                                <span class="icon-wrap icon-wrap-xs bg-trans-dark" id="iconk"></span> New Bridge
                                            </a>
                                        </li>
