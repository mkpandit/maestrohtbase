		...
		<div class="tab-base span7">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                     ...
                                     <li>
                                        <a href="#demo-lft-tab-2" data-toggle="tab">{provides_title}</a>
                                    </li>

                                    <li>
                                        <a href="#demo-lft-tab-3" data-toggle="tab">{requirements_title}</a>
                                    </li>

                                   <li>
                                        <a href="#demo-lft-tab-4" data-toggle="tab">{howto_title}</a>
                                    </li>

                                     <li>
                                        <a href="#demo-lft-tab-5" data-toggle="tab">{type_title}</a>
                                    </li>

                               		<li>
                                        <a href="#demo-lft-tab-6" data-toggle="tab">{deployment_title}</a>
                                    </li>

                                   <li>
                                        <a href="#demo-lft-tab-7" data-toggle="tab">{tested_title}</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="demo-lft-tab-4">
                                    				<h3>{howto_title}</h3>
													<span class="pill">{howto_content}</span>
                                    </div>
