<?php
/**
 * sanboot-storage-about Boot-Service
 *
...
class sanboot_storage_about_bootservice
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/sanboot-storage-about-bootservice.tpl.php');
