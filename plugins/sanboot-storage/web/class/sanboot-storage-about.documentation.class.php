...
class sanboot_storage_about_documentation
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/sanboot-storage-about-documentation.tpl.php');
		...
		$t->add($this->lang['howto_content'], 'howto_content');
