...
def main():
	...
	parser.add_argument('-n', '--name', required=False, action='store', help='Datacenter name')
	parser.add_argument('-a', '--cluster', required=True, action='store', help='Cluster name')
	...
	try:
		...
		libvmtask.destroy_cluster(service_instance, args.name, args.cluster)
