...
def main():
	...
	parser.add_argument('-v', '--vswitch', required=True, action='store', help='vSwitch name')
	parser.add_argument('-x', '--numports', required=True, action='store', help='Number of available ports')
	parser.add_argument('-e', '--nicname', required=False, action='store', help='Network card name')
	...
	try:
		...
		libvmtask.update_vswitch(service_instance, args.name, args.vswitch, args.numports, args.nicname)
