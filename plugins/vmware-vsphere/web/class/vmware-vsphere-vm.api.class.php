...
class vmware_vsphere_vm_api
{
	...
	function __construct($controller) {
		...
		$this->statfile  = 'vmware-vsphere-stat/'.$resource->id.'.pick_iso_config';
	}
	...
	function filepicker() {
		...
		if ($iso_path !== '') {
		    ...
		    $command  = $this->controller->htvcenter->get('basedir')."/plugins/vmware-vsphere/bin/htvcenter-vmware-vsphere-vm post_iso_list -i ".$this->resource->ip;
			$command .= ' --htvcenter-ui-user '.$this->user->name;
			$command .= ' --htvcenter-cmd-mode background';
		    $file = $this->controller->htvcenter->get('webdir').'/plugins/vmware-vsphere/vmware-vsphere-stat/'.$this->resource->ip.'.pick_iso_config';
