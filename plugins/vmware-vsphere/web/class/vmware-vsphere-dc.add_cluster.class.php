...
class vmware_vsphere_dc_add_cluster
{
/**
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/vmware-vsphere-dc-add_cluster.tpl.php');
	...
	function ds_add_cluster() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			$command     = $this->htvcenter->get('basedir')."/plugins/vmware-vsphere/bin/htvcenter-vmware-vsphere-datacenter addcluster -i ".$this->resource->ip." -n ".$this->datacenter;
			$command .= ' -c '.$name;
	...
	function get_response() {
		...
		$form = $response->get_form($this->actions_name, 'add_cluster');
