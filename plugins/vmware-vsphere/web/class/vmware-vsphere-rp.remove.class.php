<?php
/**
 * vSphere Hosts remove ResourcePool
 *
...
class vmware_vsphere_rp_remove
{
/**
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/vmware-vsphere-rp-remove.tpl.php');
		...
		if( $vswitch_arr !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				foreach($vswitch_arr as $key => $vs) {
					...
					$command  = $this->htvcenter->get('basedir')."/plugins/vmware-vsphere/bin/htvcenter-vmware-vsphere-rp remove -i ".$this->resource->ip." -n ".$vs;
