<?php
/**
 * vmware-vsphere-about Documentation
 *
...
class vmware_vsphere_about_documentation
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/vmware-vsphere-about-documentation.tpl.php');
