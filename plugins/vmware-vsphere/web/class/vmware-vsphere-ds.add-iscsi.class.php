<?php
/**
 * vSphere Hosts Add iSCSI DataStore
 *
...
class vmware_vsphere_ds_add_iscsi
{
/**
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/vmware-vsphere-ds-add-iscsi.tpl.php');
	...
	function ds_add_iscsi() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			$command  = $this->htvcenter->get('basedir')."/plugins/vmware-vsphere/bin/htvcenter-vmware-vsphere-datastore add_iscsi";
