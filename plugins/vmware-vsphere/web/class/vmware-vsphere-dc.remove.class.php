...
class vmware_vsphere_dc_remove
{
/**
...
//		$this->response->add($this->identifier_name.'[]', '');
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/vmware-vsphere-dc-remove.tpl.php');
	...
	function remove() {
		...
		if( $datacenter !== '' ) {
			...
			$i = 0;
			$d['param_f'.$i]['label']                       = $datacenter;
			$d['param_f'.$i]['object']['type']              = 'htmlobject_input';
			$d['param_f'.$i]['object']['attrib']['type']    = 'checkbox';
			$d['param_f'.$i]['object']['attrib']['name']    = $this->identifier_name;
			$d['param_f'.$i]['object']['attrib']['value']   = $datacenter;
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				$command  = $this->htvcenter->get('basedir')."/plugins/vmware-vsphere/bin/htvcenter-vmware-vsphere-datacenter remove";
				$command .= " -i ".$this->resource->ip;
				$command .= " -n ".$datacenter;
