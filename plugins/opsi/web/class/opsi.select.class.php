...
var $lang = array();
	...
	function action() {
		$table = $this->select();
		$t = $this->response->html->template($this->tpldir.'/opsi-select.tpl.php');
	...
	function select() {
		...
		$deployment->get_instance_by_type("opsi-deployment");
		$table = $this->response->html->tablebuilder('opsi_select', $this->response->get_array($this->actions_name, 'select'));
