...
class tftpd_about_documentation
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/tftpd-about-documentation.tpl.php');
		...
		$t->add($this->basedir."/tftpboot/", 'config_file');
