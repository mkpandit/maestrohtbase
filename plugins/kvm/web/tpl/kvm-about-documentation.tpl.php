...
<div class="row">
 <div class="tab-base span7">
 	...
 	<ul class="nav nav-tabs">
									...
									<li>
										<a href="#demo-lft-tab-4" data-toggle="tab">{type_title}</a>
									</li>
									<li>
										<a href="#demo-lft-tab-5" data-toggle="tab">{deployment_title}</a>
									</li>
									<li>
										<a href="#demo-lft-tab-6" data-toggle="tab">Test</a>
									</li>
