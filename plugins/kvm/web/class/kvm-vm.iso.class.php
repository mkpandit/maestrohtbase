...
var $lang = array();
	...
	function __construct($htvcenter, $response) {
		...
		$this->statfile  = $this->htvcenter->get('basedir').'/plugins/kvm/web/kvm-stat/'.$resource->id.'.pick_iso_config';
...
//		echo $response;
	 ...
	 *
	 * for testing
	 * http://cloud/htvcenter/base/plugins/kvm/index-vm.php?appliance_id=&kvm_vm_action=iso&appliance_id=2&path=/tmp
	 *
	 */
	//--------------------------------------------
	function iso() {
		...
		if ($iso_path !== '') {
		    ...
		    $command  = $this->htvcenter->get('basedir')."/plugins/kvm/bin/htvcenter-kvm-vm iso";
		    $command .= ' -q '.$iso_path;
		    $command .= ' -u '.$this->htvcenter->admin()->name.' -p '.$this->htvcenter->admin()->password;
			$command .= ' --htvcenter-ui-user '.$this->user->name;
			$command .= ' --htvcenter-cmd-mode background';

		    $file = $this->htvcenter->get('basedir').'/plugins/kvm/web/kvm-stat/'.$this->resource->id.'.pick_iso_config';
