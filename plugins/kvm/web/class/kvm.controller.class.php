...
var $lang = array(
	...
	function edit( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_edit($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
	...
	function addvg( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_addvg($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
	...
	function removevg( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_removevg($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->rootdir.'/plugins/device-manager/tpl/';
			$controller->message_param   = $this->message_param;
			$controller->identifier_name = $this->identifier_name;
	...
	function volgroup( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_volgroup($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
			$controller->identifier_name = $this->identifier_name;
	...
	function add( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                = new kvm_add($this->htvcenter, $this->response, $this);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->tpldir;
			$controller->message_param = $this->message_param;
	...
	function remove( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_remove($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
			$controller->identifier_name = $this->identifier_name;
	...
	function image( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_image($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
			$controller->identifier_name = $this->identifier_name;
	...
	function snap( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_snap($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
			$controller->identifier_name = $this->identifier_name;
	...
	function duplicate( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_clone($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
			$controller->identifier_name = $this->identifier_name;
	...
	function resize( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller                  = new kvm_resize($this->htvcenter, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
			$controller->identifier_name = $this->identifier_name;
	...
	function __reload($mode) {
		...
		// reload volume group
		if($mode === 'vg') {
			$file = $htvcenter_SERVER_BASE_DIR.'/plugins/kvm/web/storage/'.$resource->id.'.vg.stat';
			$command .= $htvcenter_SERVER_BASE_DIR.'/plugins/kvm/bin/htvcenter-kvm post_vg -t '.$deployment->type;
		}
		// reload logical volumes
		if($mode === 'lv') {
			$file = $htvcenter_SERVER_BASE_DIR.'/plugins/kvm/web/storage/'.$resource->id.'.'.$volgroup.'.lv.stat';
			$command .= $htvcenter_SERVER_BASE_DIR.'/plugins/kvm/bin/htvcenter-kvm post_lv';
