	...
	*/
	var $lang = array(
		...
		function __construct($htvcenter, $response) {
			...
			$this->lang     = $this->user->translate($this->lang, $this->rootdir."/plugins/puppet/lang", 'node-class.ini');
		...
		function select( $hidden = true ) {
			$data = '';
			if( $hidden === true ) {
				require_once($this->rootdir.'/plugins/puppet/class/node-class.select.class.php');
				$controller = new node_class_select($this->htvcenter, $this->response);
		...
		function add( $hidden = true ) {
			$data = '';
			if( $hidden === true ) {
				require_once($this->rootdir.'/plugins/puppet/class/node-class.add.class.php');
				$controller = new node_class_add($this->htvcenter, $this->response);
				$controller->actions_name  = $this->actions_name;
				$controller->tpldir        = $this->tpldir;
				$controller->message_param = $this->message_param;
		...
		function remove( $hidden = true ) {
			...
			if( $hidden === true ) {
				require_once($this->rootdir.'/plugins/puppet/class/node-class.remove.class.php');
				$controller = new node_class_remove($this->htvcenter, $this->response);
				$controller->actions_name  = $this->actions_name;
				$controller->tpldir        = $this->tpldir;
				$controller->message_param = $this->message_param;
		...
		function edit( $hidden = true ) {
			...
			$data = '';
			if( $hidden === true ) {
				require_once($this->rootdir.'/plugins/puppet/class/node-class.edit.class.php');
				$controller = new node_class_edit($this->htvcenter, $this->response);
				$controller->actions_name  = $this->actions_name;
				$controller->tpldir        = $this->tpldir;
				$controller->message_param = $this->message_param;
