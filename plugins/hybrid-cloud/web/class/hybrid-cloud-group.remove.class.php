...
class hybrid_cloud_group_remove
{
/**
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/hybrid-cloud-group-remove.tpl.php');
	...
	function remove() {
		...
		if(!$form->get_errors() && $response->submit()) {
			...
			$command  = $this->htvcenter->get('basedir').'/plugins/hybrid-cloud/bin/htvcenter-hybrid-cloud-group remove';
			$command .= ' -i '.$hc->id;
