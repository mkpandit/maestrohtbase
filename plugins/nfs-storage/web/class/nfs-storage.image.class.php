			...
			switch ($image_command) {
				case 'add':
					...
					if (strlen($image->id)) {
						...
						$ident_file = $this->htvcenter->get('basedir').'/plugins/nfs-storage/web/storage/'.$this->resource->id.'.nfs.'.$image_name.'.adapt';
						$get_ident_command  = $this->htvcenter->get('basedir').'/plugins/nfs-storage/bin/htvcenter-nfs-storage adapt';
