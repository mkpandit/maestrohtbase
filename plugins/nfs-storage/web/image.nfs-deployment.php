...
function get_nfs_deployment_image_rootdevice_identifier($nfs_storage_id) {
	...
	if (file_exists($statfile_manual)) {
		...
		// send command
		$resource_command=$htvcenter_SERVER_BASE_DIR."/htvcenter/plugins/nfs-storage/bin/htvcenter-nfs-storage post_identifier -u ".$htvcenter_ADMIN->name." -p ".$htvcenter_ADMIN->password." --htvcenter-cmd-mode background";
