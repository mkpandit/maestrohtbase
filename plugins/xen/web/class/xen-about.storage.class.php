...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/xen-about-storage.tpl.php');
		$t->add($this->response->html->thisfile, "thisfile");
		$t->add($this->lang['label'], 'label');
		$t->add($this->lang['storage_mgmt_title'], 'storage_mgmt_title');
		$t->add($this->lang['storage_mgmt_list'], 'storage_mgmt_list');
