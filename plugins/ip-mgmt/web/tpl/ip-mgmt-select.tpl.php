...
<div id="volumepopuprem" class="modal-dialog longdialog">
<div class="panel">
                                ...
                                <div id="demo-cls-wz">
                                    ...
                                    <ul class="wz-nav-off wz-icon-inline wz-classic">
                                        <li class="col-xs-3 bg-info active">
                                            <a href="#demo-cls-tab1" data-toggle="tab" aria-expanded="true">
                                                <span class="icon-wrap icon-wrap-xs bg-trans-dark"><i class="fa fa-close"></i></span> Delete
                                            </a>
                                        </li>
                                        <div class="volumepopupclass"><a id="volumepopupcloserem"><i class="fa fa-icon fa-close"></i></a></div>
