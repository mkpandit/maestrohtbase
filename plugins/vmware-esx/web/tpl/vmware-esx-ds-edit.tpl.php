...
<div id="form">
	<div style="width:400px;float:left;">
		<div><b>{lang_id}</b>: <span id="vmwaredsid">{id}</span></div>
	...
	<div style="width:230px;float:right;">
		<div id="addnewnas">{ds_add_nas}</div>
		<div id="addnewiscsi">{ds_add_iscsi}</div>
	</div>
                                    ...
                                    <ul class="wz-nav-off wz-icon-inline wz-classic">
                                        <li class="col-xs-3 bg-info active">
                                            <a href="#demo-cls-tab1" data-toggle="tab" aria-expanded="true">
                                                <span class="icon-wrap icon-wrap-xs bg-trans-dark"><i class="fa fa-hdd-o"></i></span> Add new
                                            </a>
                                        </li>
