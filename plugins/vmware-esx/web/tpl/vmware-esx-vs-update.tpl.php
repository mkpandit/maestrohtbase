...
<div id="form">
	<div style="width:250px;float:left;" id="alignelo">
	...
	<div style="width:300px;float:right;" id="vmwareaddportgroup">
		{add_pg}
	</div>
                                    ...
                                    <ul class="wz-nav-off wz-icon-inline wz-classic">
                                        <li class="col-xs-3 bg-info active">
                                            <a href="#demo-cls-tab1" data-toggle="tab" aria-expanded="true">
                                                <span class="icon-wrap icon-wrap-xs bg-trans-dark"><i class="fa fa-plus"></i></span> Add Portgroup
                                            </a>
                                        </li>
                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active in" id="demo-cls-tab1">
                                                    ...
                                                    <div id="storageformvmware" class="vmwarealignzzz">
