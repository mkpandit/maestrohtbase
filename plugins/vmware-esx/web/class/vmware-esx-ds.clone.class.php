...
var $lang = array();
	...
	function __construct($htvcenter, $response) {
		...
		$this->statfile  = $this->htvcenter->get('webdir').'/plugins/vmware-esx/vmware-esx-stat/'.$resource->ip.'.vmdk_list';
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/vmware-esx-ds-clone.tpl.php');
	...
	function duplicate() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			$command     = $this->htvcenter->get('basedir').'/plugins/vmware-esx/bin/htvcenter-vmware-esx-datastore clone_vmdk';
