<?php
/**
 * ESX Hosts Add PortGroup to VSwitch
 *
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/vmware-esx-vs-add-pg.tpl.php');
	...
	function ne_add_vs_pg() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			$command  = $this->htvcenter->get('basedir')."/plugins/vmware-esx/bin/htvcenter-vmware-esx-network add_pg"; 
