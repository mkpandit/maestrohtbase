...
* @var int
*/
var $message_css = 'msgBox alert alert-warning alert-dismissible';
/**
	...
	*/
	...
	function _get_messagebox() {
		...
		if($this->get_request($this->message_param) != "") {
			...
			$_strReturn .= '';
			$_strReturn .= '<div class="'.$this->message_css.'" id="'.$this->prefix.'msgBox"><button data-dismiss="alert" class="close"><span>×</span></button>'.$msg.'</div>';
			$_strReturn .= '<script>';
