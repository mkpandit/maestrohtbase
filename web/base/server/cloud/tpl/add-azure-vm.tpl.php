...
<div class="row">
	...
	<div class="row">
		<div id="azure-pane">
			...
			{azure_password}
			<pre>
				<h4>Provided password must:</h4>
				1. be of 8-72 character long<br />
				2. have least one upper case character<br />
				3. have least one lower case character<br />
				4. have least one digit<br />
				5. have least one special character<br />
			</pre>
