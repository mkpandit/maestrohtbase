...
class datacenter_api
{
	...
	function eventlist() {
		// check permissions
		$this->controller->htvcenter->init();
		$class ='event_controller';
		$path  = $this->controller->htvcenter->get('webdir').'/server/event/class/event.controller.class.php';
		$role  = $this->controller->htvcenter->role($this->response);
		require_once($path);
		$controller = new $class($this->controller->htvcenter, $this->response);
	...
	//--------------------------------------------
	function statistics() {
		require_once($this->controller->htvcenter->get('basedir').'/web/base/server/aa_server/class/datacenter.class.php');
		$data = new datacenter();
	...
	function storage_list() {
			require_once($this->controller->htvcenter->get('basedir').'/web/base/class/storage.class.php');
			require_once($this->controller->htvcenter->get('basedir').'/web/base/class/deployment.class.php');
	...
	function server_list() {
			require_once($this->controller->htvcenter->get('basedir').'/web/base/class/appliance.class.php');
			require_once($this->controller->htvcenter->get('basedir').'/web/base/class/virtualization.class.php');
