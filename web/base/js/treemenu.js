...
function {toggle_function_name}(nodeid)
{
	...
	parseCollapseString();
	if (!IE4) {
		sonLayer = document.getElementById( nodeid + 'son');
		nodeLayer = document.getElementById( nodeid + 'node');
		folderLayer = document.getElementById( nodeid + 'folder');
	} else {
		sonLayer = document.all( nodeid + 'son');
		nodeLayer = document.all( nodeid + 'node');
		folderLayer = document.all( nodeid + 'folder');
	}
